...
* @version:1.0
*/
int StudentExamModel::submit(QList<Choice> choiceAns, QList<Choice> multichoiceAns, QList<Judge> judgeAns, int examCode,int objectScore, int multiScore,int judgeScore) {
	int i;
	int choiceFlag;
	int multichoiceFlag;
	int judgeFlag;
